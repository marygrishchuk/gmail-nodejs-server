...
app.post('/sendMessage', async (req, res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            (err, info) => {
                console.log('senderNotifiedInfo.envelope: ' + info.envelope);
                console.log('senderNotifiedInfo.messageId: ' + info.messageId);
            })
        ...
        await transporter.sendMail({
            ...
            (err, info) => {
                console.log('mailSentToMeInfo.envelope: ' + info.envelope);
                console.log('mailSentToMeInfo.messageId: ' + info.messageId);
            })
        res.send('ok')
    } catch (error) {
